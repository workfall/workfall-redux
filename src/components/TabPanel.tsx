...
const getLastAndFirstCSSClass = (position: Position | undefined): string => {
...
const Tab: FunctionComponent<TabProps> = ({ position, tabName, flexBasis, handleTabClick, id }) => {
    const styleClass = getLastAndFirstCSSClass(position)
